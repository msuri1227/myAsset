...
//        self.secondDropDownTxtField.isUserInteractionEnabled = false
        ...
        menudropDown.selectionAction = { [unowned self] (index: Int, item: String) in
            if self.dropDownSelectString == "First"{
                ...
                self.dropDownSelectString = ""
            }else if self.dropDownSelectString == "Menu" {
                if item == "Sync_Application".localized() {
                ...
                }else if item == "Log_Out_Clear_Data".localized(){
                    myAssetDataManager.uniqueInstance.resetUserData()
                }else if item == "Share_logs".localized() {
                    shareLogs(fwLogs: false)
                ...
                }else if item == "Change_Logs".localized(){
                    DispatchQueue.main.async{
    ...
    @IBAction func moreOptionsMenuaction(_ sender: Any) {
        ...
        menuarr = dashBoardMenuArray
        imgArray = dashBoardMenuimgArray
        ...
        self.dropDownSelectString = "Menu"
        menudropDown.show()
        mJCLogger.log("Ended", Type: "info")
...
//                        self.present(assetMapDeatilsVC, animated: false, completion: nil)
    ...
    @objc func Addbuttontapped(sender : UIButton) {
        ...
        if sender.tag == 1000{
            ...
            createNewJobVC.isScreen = "dashboard"
