...
class ScreenManager: NSObject {
    ...
    static func getComponentAvailabilityScreen() -> ComponentAvailabilityVC{
        if DeviceType == iPad{
            return ComponentAvailabilityVC.instantiate(fromAppStoryboard: .CreateSB_iPad)
        }else{
            return ComponentAvailabilityVC.instantiate(fromAppStoryboard: .CreateSB_iPhone)
        }
    }
    static func getSupervisorMasterListScreen() -> SupervisorMasterListVC{
        return SupervisorMasterListVC.instantiate(fromAppStoryboard: .SupervisorSB_iPad)
    }
    static func getAssetMapSplitScreen() -> AssetMapSplitVC{
        return AssetMapSplitVC.instantiate(fromAppStoryboard: .AssetMapSB_iPad)
    }
    static func getAssetMapMasterScreen() -> AssetMapMasterVC{
        return AssetMapMasterVC.instantiate(fromAppStoryboard: .AssetMapSB_iPad)
    }
    static func getAssetMapDeatilsScreen() -> AssetMapDeatilsVC{
        if DeviceType == iPad{
            return AssetMapDeatilsVC.instantiate(fromAppStoryboard: .AssetMapSB_iPad)
        }else{
            return AssetMapDeatilsVC.instantiate(fromAppStoryboard: .AssetMapSB_iPhone)
        }
    }
    static func getAssetHierarchyScreen() -> AssetHierarchyVC{
        if DeviceType == iPad{
            return AssetHierarchyVC.instantiate(fromAppStoryboard: .FlocEquipSB_iPad)
        }else{
            return AssetHierarchyVC.instantiate(fromAppStoryboard: .FlocEquipSB_iPhone)
        }
    }
    static func getOnlineSearchScreen() -> OnlineSearchVC{
        if DeviceType == iPad{
            return OnlineSearchVC.instantiate(fromAppStoryboard: .OnlineSB_iPad)
        }else{
            return OnlineSearchVC.instantiate(fromAppStoryboard: .OnlineSB_iPhone)
        }
    }
    static func getNotificationAttachmentScreen() -> NotificationAttachmentVC{
        if DeviceType == iPad{
            return NotificationAttachmentVC.instantiate(fromAppStoryboard: .NotificationSB_iPad)
        }else{
            return NotificationAttachmentVC.instantiate(fromAppStoryboard: .NotificationSB_iPhone)
        }
    }
    static func getNotificationHistoryAndPendingScreen() -> NotificationHistoryAndPendingVC{
        if DeviceType == iPad{
            return NotificationHistoryAndPendingVC.instantiate(fromAppStoryboard: .NotificationSB_iPad)
        }else{
            return NotificationHistoryAndPendingVC.instantiate(fromAppStoryboard: .NotificationSB_iPhone)
        }
    }
    static func getTeamDetailsScreen() -> TeamDetailsVC{
        if DeviceType == iPad{
            return TeamDetailsVC.instantiate(fromAppStoryboard: .SupervisorSB_iPad)
        }else{
            return TeamDetailsVC.instantiate(fromAppStoryboard: .SupervisorSB_iPhone)
        }
    }
    static func getTeamMasterScreen() -> TeamMasterVC{
        if DeviceType == iPad{
            return TeamMasterVC.instantiate(fromAppStoryboard: .SupervisorSB_iPad)
        }else{
            return TeamMasterVC.instantiate(fromAppStoryboard: .SupervisorSB_iPhone)
        }
    }
    static func getTeamSplitScreen() -> TeamSplitVC{
        if DeviceType == iPad{
            return TeamSplitVC.instantiate(fromAppStoryboard: .SupervisorSB_iPad)
        }else{
            return TeamSplitVC.instantiate(fromAppStoryboard: .SupervisorSB_iPhone)
        }
    }
    static func getSupervisorTimeSheetScreen() -> SupervisorTimeSheetVC{
        if DeviceType == iPad{
            return SupervisorTimeSheetVC.instantiate(fromAppStoryboard: .SupervisorSB_iPad)
        }else{
            return SupervisorTimeSheetVC.instantiate(fromAppStoryboard: .SupervisorSB_iPhone)
        }
    }
    static func getComponentScreen() -> ComponentsVC{
        if DeviceType == iPad{
            return ComponentsVC.instantiate(fromAppStoryboard: .WorkorderSB_iPad)
        }else{
            return ComponentsVC.instantiate(fromAppStoryboard: .WorkorderSB_iPhone)
        }
    }
    static func getNotificationActivityScreen() -> NotificationActivityVC{
        if DeviceType == iPad{
            return NotificationActivityVC.instantiate(fromAppStoryboard: .NotificationSB_iPad)
        }else{
            return NotificationActivityVC.instantiate(fromAppStoryboard: .NotificationSB_iPhone)
        }
    }
    static func getNotificationItemScreen() -> NotificationItemVC{
        if DeviceType == iPad{
            return NotificationItemVC.instantiate(fromAppStoryboard: .NotificationSB_iPad)
        }else{
            return NotificationItemVC.instantiate(fromAppStoryboard: .NotificationSB_iPhone)
        }
    }
    static func getNotificationTaskScreen() -> NotificationTaskVC{
        if DeviceType == iPad{
            return NotificationTaskVC.instantiate(fromAppStoryboard: .NotificationSB_iPad)
        }else{
            return NotificationTaskVC.instantiate(fromAppStoryboard: .NotificationSB_iPhone)
        }
    }
    static func getHistoryAndPendingOprDetailsScreen() -> HistoryAndPendingOprDetailsVC{
        if DeviceType == iPad{
            return HistoryAndPendingOprDetailsVC.instantiate(fromAppStoryboard: .WorkorderSB_iPad)
        }else{
            return HistoryAndPendingOprDetailsVC.instantiate(fromAppStoryboard: .WorkorderSB_iPhone)
        }
    }
    static func getHistoryAndPendingOprListScreen() -> HistoryAndPendingOprListVC{
        if DeviceType == iPad{
            return HistoryAndPendingOprListVC.instantiate(fromAppStoryboard: .WorkorderSB_iPad)
        }else{
            return HistoryAndPendingOprListVC.instantiate(fromAppStoryboard: .WorkorderSB_iPhone)
        }
    }
    static func getHistoryAndPendingOprSplitScreen() -> HistoryAndPendingOprSplitVC{
        if DeviceType == iPad{
            return HistoryAndPendingOprSplitVC.instantiate(fromAppStoryboard: .WorkorderSB_iPad)
        }else{
            return HistoryAndPendingOprSplitVC.instantiate(fromAppStoryboard: .WorkorderSB_iPhone)
        }
    }
    static func getComponentListScreen() -> ComponentListVC{
        if DeviceType == iPad{
            return ComponentListVC.instantiate(fromAppStoryboard: .WorkorderSB_iPad)
        }else{
            return ComponentListVC.instantiate(fromAppStoryboard: .WorkorderSB_iPhone)
        }
    }
    static func getMultipleInspectionResultCaptureScreen() -> MultipleInspectionResultCaptureVC{
        if DeviceType == iPad{
            return MultipleInspectionResultCaptureVC.instantiate(fromAppStoryboard: .WorkorderSB_iPad)
        }else{
            return MultipleInspectionResultCaptureVC.instantiate(fromAppStoryboard: .WorkorderSB_iPhone)
        }
    }
    static func getInspectionLotScreen() -> InspectionsVC{
        if DeviceType == iPad{
            return InspectionsVC.instantiate(fromAppStoryboard: .WorkorderSB_iPad)
        }else{
            return InspectionsVC.instantiate(fromAppStoryboard: .WorkorderSB_iPhone)
        }
    }
    static func getRecordPointsScreen() -> RecordPointsVC{
        if DeviceType == iPad{
            return RecordPointsVC.instantiate(fromAppStoryboard: .WorkorderSB_iPad)
        }else{
            return RecordPointsVC.instantiate(fromAppStoryboard: .WorkorderSB_iPhone)
        }
    }
    static func getChartScreen() -> ChartVC{
        if DeviceType == iPad{
            return ChartVC.instantiate(fromAppStoryboard: .CreateSB_iPad)
        }else{
            return ChartVC.instantiate(fromAppStoryboard: .CreateSB_iPhone)
        }
    }
    static func getNotificationItemListScreen() -> NotificationItemList{
        if DeviceType == iPad{
            return NotificationItemList.instantiate(fromAppStoryboard: .NotificationSB_iPad)
        }else{
            return NotificationItemList.instantiate(fromAppStoryboard: .NotificationSB_iPhone)
        }
    }
    static func getHistoryAndPendingScreen() -> HistoryAndPendingVC{
        if DeviceType == iPad{
            return HistoryAndPendingVC.instantiate(fromAppStoryboard: .WorkorderSB_iPad)
        }else{
            return HistoryAndPendingVC.instantiate(fromAppStoryboard: .WorkorderSB_iPhone)
        }
    }
    static func getSupervisorDetailsScreen() -> SupervisorDetailsVC{
        if DeviceType == iPad{
            return SupervisorDetailsVC.instantiate(fromAppStoryboard: .SupervisorSB_iPad)
        }else{
            return SupervisorDetailsVC.instantiate(fromAppStoryboard: .SupervisorSB_iPhone)
        }
    }
    static func getNotificationItemMainScreen() -> NotificationItemMainVC{
        if DeviceType == iPad{
            return NotificationItemMainVC.instantiate(fromAppStoryboard: .NotificationSB_iPad)
        }else{
            return NotificationItemMainVC.instantiate(fromAppStoryboard: .NotificationSB_iPhone)
        }
    }
    static func getNotificationMainTaskScreen() -> NotificationMainTaskVC{
        if DeviceType == iPad{
            return NotificationMainTaskVC.instantiate(fromAppStoryboard: .NotificationSB_iPad)
        }else{
            return NotificationMainTaskVC.instantiate(fromAppStoryboard: .NotificationSB_iPhone)
        }
    }
    static func getCreateComponentScreen() -> CreateComponentVC{
        if DeviceType == iPad{
            return CreateComponentVC.instantiate(fromAppStoryboard: .CreateSB_iPad)
        }else{
            return CreateComponentVC.instantiate(fromAppStoryboard: .CreateSB_iPhone)
        }
    }
    static func getCreateItemScreen() -> CreateItemVC{
        if DeviceType == iPad{
            return CreateItemVC.instantiate(fromAppStoryboard: .CreateSB_iPad)
        }else{
            return CreateItemVC.instantiate(fromAppStoryboard: .CreateSB_iPhone)
        }
    }
    static func getCreateActivityScreen() -> CreateActivityVC{
        if DeviceType == iPad{
            return CreateActivityVC.instantiate(fromAppStoryboard: .CreateSB_iPad)
        }else{
            return CreateActivityVC.instantiate(fromAppStoryboard: .CreateSB_iPhone)
        }
    }
    static func getIssueComponentScreen() -> IssueComponentVC{
        if DeviceType == iPad{
            return IssueComponentVC.instantiate(fromAppStoryboard: .CreateSB_iPad)
        }else{
            return IssueComponentVC.instantiate(fromAppStoryboard: .CreateSB_iPhone)
        }
    }
    static func getCreateItemCauseScreen() -> CreateItemCauseVC{
        if DeviceType == iPad{
            return CreateItemCauseVC.instantiate(fromAppStoryboard: .CreateSB_iPad)
        }else{
            return CreateItemCauseVC.instantiate(fromAppStoryboard: .CreateSB_iPhone)
        }
    }
    static func getCreateTaskScreen() -> CreateTaskVC{
        if DeviceType == iPad{
            return CreateTaskVC.instantiate(fromAppStoryboard: .CreateSB_iPad)
        }else{
            return CreateTaskVC.instantiate(fromAppStoryboard: .CreateSB_iPhone)
        }
    }
    static func getInspectionOperationsScreen() -> InspectionOperationsVC{
        if DeviceType == iPad{
            return InspectionOperationsVC.instantiate(fromAppStoryboard: .WorkorderSB_iPad)
        }else{
            return InspectionOperationsVC.instantiate(fromAppStoryboard: .WorkorderSB_iPhone)
        }
    }
    static func getNotificationItemCausesScreen() -> NotificationItemCausesVC{
        if DeviceType == iPad{
            return NotificationItemCausesVC.instantiate(fromAppStoryboard: .NotificationSB_iPad)
        }else{
            return NotificationItemCausesVC.instantiate(fromAppStoryboard: .NotificationSB_iPhone)
        }
    }
    static func getSupervisorSplitScreen() -> SupervisorSplitVC{
        return SupervisorSplitVC.instantiate(fromAppStoryboard: .SupervisorSB_iPad)
    }
    static func getOnlineWorkOrderOverViewScreen() -> OnlineWorkOrderOverViewVC{
        if DeviceType == iPad{
            return OnlineWorkOrderOverViewVC.instantiate(fromAppStoryboard: .OnlineSB_iPad)
        }else{
            return OnlineWorkOrderOverViewVC.instantiate(fromAppStoryboard: .OnlineSB_iPhone)
        }
    }
    static func getOnlineItemOprScreen() -> OnlineItemOprVC{
        if DeviceType == iPad{
            return OnlineItemOprVC.instantiate(fromAppStoryboard: .OnlineSB_iPad)
        }else{
            return OnlineItemOprVC.instantiate(fromAppStoryboard: .OnlineSB_iPhone)
        }
    }
    static func getOnlineNotificationOverViewScreen() -> OnlineNotificationOverViewVC{
        if DeviceType == iPad{
            return OnlineNotificationOverViewVC.instantiate(fromAppStoryboard: .OnlineSB_iPad)
        }else{
            return OnlineNotificationOverViewVC.instantiate(fromAppStoryboard: .OnlineSB_iPhone)
        }
    }
    static func getSupervisorMapSplictScreen() -> SupervisorMapSplictVC{
        return SupervisorMapSplictVC.instantiate(fromAppStoryboard: .SupervisorSB_iPad)
    }
    //myAsset
    static func searchAssestTagScreen() -> SearchAssestVC{
        if DeviceType == iPad{
            return SearchAssestVC.instantiate(fromAppStoryboard: .myAsset_iPad)
        }else{
            return SearchAssestVC.instantiate(fromAppStoryboard: .myAsset_iPhone)
        }
    }
    static func getAssetListVCScreen() -> AssetListVC{
        if DeviceType == iPad{
            return AssetListVC.instantiate(fromAppStoryboard: .myAsset_iPad)
        }else{
            return AssetListVC.instantiate(fromAppStoryboard: .myAsset_iPhone)
        }
    }
    static func searchAssestDetailsScreen() -> AssetDetailsVC{
        if DeviceType == iPad{
            return AssetDetailsVC.instantiate(fromAppStoryboard: .myAsset_iPad)
        }
        else{
            return AssetDetailsVC.instantiate(fromAppStoryboard: .myAsset_iPhone)
        }
    }
    static func getAssetLocationScreen() -> AssetLocationVC{
        if DeviceType == iPad{
            return AssetLocationVC.instantiate(fromAppStoryboard: .myAsset_iPad)
        }else{
            return AssetLocationVC.instantiate(fromAppStoryboard: .myAsset_iPhone)
        }
    }
    ...
    static func registerTabCell(collectionView: UICollectionView){
        collectionView.register(UINib(nibName: customCell.tabCell, bundle: Bundle(identifier:"com.ods.ODSFoundation")), forCellWithReuseIdentifier: customCell.tabCell)
    }
    ...
    static func getReadingpointsTableViewCell(tableView:UITableView) -> ReadingpointsTableViewCell{
        if DeviceType == iPad{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.readingpointsTableViewCell)_iPad") as! ReadingpointsTableViewCell
            return cell
        }else{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.readingpointsTableViewCell)_iPhone") as! ReadingpointsTableViewCell
            return cell
        }
    }
    ...
    static func getHistoryAndPendingOperationOverViewCell(tableView:UITableView) -> HistoryAndPendingOperationOverViewCell{
        let cell = tableView.dequeueReusableCell(withIdentifier: customCell.historyAndPendingOperationOverViewCell) as! HistoryAndPendingOperationOverViewCell
        return cell
    }
    ...
    static func getHistoryCell(tableView:UITableView) -> HistoryCell{
        if DeviceType == iPad{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.historyCell)_iPad") as! HistoryCell
            return cell
        }else{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.historyCell)_iPhone") as! HistoryCell
            return cell
        }
    }
    ...
    static func getInspectionCell(tableView:UITableView) -> InspectionCell{
        if DeviceType == iPad{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.inspectionCell)_iPad") as! InspectionCell
            return cell
        }else{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.inspectionCell)_iPhone") as! InspectionCell
            return cell
        }
    }
    ...
    static func getOtherInfoTableViewCell(tableView:UITableView) -> OtherInfoTableViewCell{
        if DeviceType == iPad{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.otherInfoTableViewCell)_iPad") as! OtherInfoTableViewCell
            return cell
        }else{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.otherInfoTableViewCell)_iPhone") as! OtherInfoTableViewCell
            return cell
        }
    }
    ...
    static func getComponentOverViewCell(tableView:UITableView) -> ComponentOverViewCell{
        if DeviceType == iPad{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.componentOverViewCell)_iPad") as! ComponentOverViewCell
            return cell
        }else{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.componentOverViewCell)_iPhone") as! ComponentOverViewCell
            return cell
        }
    }
    static func getComponentAdditionalDataCell(tableView:UITableView) -> ComponentAdditionalDataCell{
        if DeviceType == iPad{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.componentAdditionalDataCell)_iPad") as! ComponentAdditionalDataCell
            return cell
        }else{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.componentAdditionalDataCell)_iPhone") as! ComponentAdditionalDataCell
            return cell
        }
    }
    ...
    static func getNotificationTaskOverViewCell(tableView:UITableView) -> NotificationTaskOverViewCell{
        if DeviceType == iPad{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.notificationTaskOverViewCell)_iPad") as! NotificationTaskOverViewCell
            return cell
        }else{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.notificationTaskOverViewCell)_iPhone") as! NotificationTaskOverViewCell
            return cell
        }
    }
    ...
    static func getItemOverViewCell(tableView:UITableView) -> ItemOverViewCell{
        if DeviceType == iPad{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.itemOverViewCell)_iPad") as! ItemOverViewCell
            return cell
        }else{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.itemOverViewCell)_iPhone") as! ItemOverViewCell
            return cell
        }
    }
    static func getItemPartsDetailsCell(tableView:UITableView) -> ItemPartsDetailsCell{
        if DeviceType == iPad{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.itemPartsDetailsCell)_iPad") as! ItemPartsDetailsCell
            return cell
        }else{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.itemPartsDetailsCell)_iPhone") as! ItemPartsDetailsCell
            return cell
        }
    }
    static func getItemDamageDetailsCell(tableView:UITableView) -> ItemDamageDetailsCell{
        if DeviceType == iPad{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.itemDamageDetailsCell)_iPad") as! ItemDamageDetailsCell
            return cell
        }else{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.itemDamageDetailsCell)_iPhone") as! ItemDamageDetailsCell
            return cell
        }
    }
    ...
    static func getNotificationItemCausesTableViewCell(tableView:UITableView) -> NotificationItemCausesTableViewCell{
        if DeviceType == iPad{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.notificationItemCausesTableViewCell)_iPad") as! NotificationItemCausesTableViewCell
            return cell
        }else{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.notificationItemCausesTableViewCell)_iPhone") as! NotificationItemCausesTableViewCell
            return cell
        }
    }
    static func getNotificationActivityOverViewCell(tableView:UITableView) -> NotificationActivityOverViewCell{
        if DeviceType == iPad{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.notificationActivityOverViewCell)_iPad") as! NotificationActivityOverViewCell
            return cell
        }else{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.notificationActivityOverViewCell)_iPhone") as! NotificationActivityOverViewCell
            return cell
        }
    }
    ...
    static func getNotificationItemCell(tableView:UITableView) -> OnlineNotificationItemCell{
        if DeviceType == iPad{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.notificationItemCell)_iPad") as! OnlineNotificationItemCell
            return cell
        }else{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.notificationItemCell)_iPhone") as! OnlineNotificationItemCell
            return cell
        }
    }
    ...
    static func getOnlineOperationsCell(tableView:UITableView) -> OnlineOperationsCell{
        if DeviceType == iPad{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.onlineOperationsCell)_iPad") as! OnlineOperationsCell
            return cell
        }else{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.onlineOperationsCell)_iPhone") as! OnlineOperationsCell
            return cell
        }
    }
    ...
    static func getOnlineNotificationOtherInfoCell(tableView:UITableView) -> OnlineNotificationOtherInfoCell{
        if DeviceType == iPad{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.onlineNotificationOtherInfoCell)_iPad") as! OnlineNotificationOtherInfoCell
            return cell
        }else{
            let cell = tableView.dequeueReusableCell(withIdentifier: "\(customCell.onlineNotificationOtherInfoCell)_iPhone") as! OnlineNotificationOtherInfoCell
            return cell
        }
    }
