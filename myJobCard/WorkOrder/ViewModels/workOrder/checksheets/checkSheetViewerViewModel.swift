                ...
                if let soDataRequest = response.value(forKey:"data") as? SODataRequestExecution {
                    ...
                    for key in responseDic.allKeys{
                        ...
                        if resourcePath == formMasterSet {
                            ...
                            let dict = FormsFormateHelperClass.getListInFormte(dictionary: NSMutableDictionary(dictionary: dictval), entityModelClassType: FormMasterModel.self)
                            ...
                            let dictval = responseDic.value(forKey: resourcePath) as! [String:Any]
                            let dict = FormsFormateHelperClass.getListInFormte(dictionary: NSMutableDictionary(dictionary: dictval), entityModelClassType: FormAttachmentModel.self)
                            ...
                            let dictval = responseDic.value(forKey: resourcePath) as! [String:Any]
                            let dict = FormsFormateHelperClass.getListInFormte(dictionary: NSMutableDictionary(dictionary: dictval), entityModelClassType: FormQuestionImageModel.self)
