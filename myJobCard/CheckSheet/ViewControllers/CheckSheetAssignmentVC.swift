...
class CheckSheetAssignmentVC: UIViewController,UITableViewDelegate,UITableViewDataSource, checkSheetSelectionDelegate,viewModelDelegate {
    ...
    func dataFetchCompleted(type: String, object: [Any]) {
        if type == "ManualCheckSheetList"{
            DispatchQueue.main.async {
                menuDataModel.uniqueInstance.presentCheckSheetAvailabilityScreen(vc: self, delegateVC: self, previousCheckSheetListArr: self.previousCheckSheetListArr)
            }
    ...
    @IBAction func chooseCheckSheetButtonAction(_ sender: Any) {
        menuDataModel.uniqueInstance.presentCheckSheetAvailabilityScreen(vc: self, delegateVC: self, previousCheckSheetListArr: self.previousCheckSheetListArr, previousSelectedCheckSheetListArr: self.selectedFormsArray, checkSheetListMasterArr: self.checkListMasterArr)
    }
