...
class FlocEquipDetialsVC: UIViewController, UIScrollViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout,TabCellDelegate,PageViewParent, viewModelDelegate,CustomNavigationBarDelegate,SlideMenuControllerSelectDelegate {
    ...
    @IBOutlet var iPhoneHeaderView: UIView!
    ...
    private func updateSlideMenu() {
        ...
        sideMenuArrray = ["Overview".localized(),"Installed_Equipments".localized(),"Classification".localized(),"Attachments".localized(),"BreakDown_Report".localized()]
        sideMenuArrrayImages = [#imageLiteral(resourceName: "OverView"),#imageLiteral(resourceName: "Components"),#imageLiteral(resourceName: "Objects"),#imageLiteral(resourceName: "AttachementsNF"),#imageLiteral(resourceName: "BreakdownReport_Black")]
    ...
    @objc func loadList(notification: NSNotification){
        mJCLogger.log("Starting", Type: "info")
        if DeviceType == iPhone{
            if tabItemArray.indices.contains(tabSelectedIndex){
                let tabitem = tabItemArray[tabSelectedIndex]
    ...
    func viewControllers() -> [UIViewController] {
        ...
        if currentMasterView == "WorkOrder" || currentMasterView == "Supervisor" {
            ...
            let noAttchmnetVc = ScreenManager.getNotificationAttachmentScreen()
            // noAttchmnetVc.attachDelegate = self
            noAttchmnetVc.objectNum = flocEquipObjText
            if flocEquipObjType == "floc" {
                noAttchmnetVc.fromScreen = "FUNCTIONALLOCATION"
            }else{
                noAttchmnetVc.fromScreen = "EQUIPMENT"
            }
            attachmentVc = noAttchmnetVc
        }
        //breakdown report
