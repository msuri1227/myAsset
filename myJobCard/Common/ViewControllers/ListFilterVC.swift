...
class ListFilterVC: UIViewController,UIScrollViewDelegate,UICollectionViewDelegate,UICollectionViewDataSource,UIGestureRecognizerDelegate{
    ...
    func setBasicView(){
        ...
        self.scrollViewContainerViewHeightConstraint.constant = self.scrollViewContainerViewHeightConstraint.constant - self.controlKeyView.frame.size.height
        self.teamMemberView.isHidden = true
        self.scrollViewContainerViewHeightConstraint.constant = self.scrollViewContainerViewHeightConstraint.constant - self.teamMemberView.frame.size.height
        self.showOnMapView.isHidden = true
        self.scrollViewContainerViewHeightConstraint.constant = self.scrollViewContainerViewHeightConstraint.constant - self.showOnMapView.frame.size.height
        self.plantView.isHidden = true
        self.scrollViewContainerViewHeightConstraint.constant = self.scrollViewContainerViewHeightConstraint.constant - self.plantView.frame.size.height
        self.unAssignedView.isHidden = true
        self.scrollViewContainerViewHeightConstraint.constant = self.scrollViewContainerViewHeightConstraint.constant - self.unAssignedView.frame.size.height
