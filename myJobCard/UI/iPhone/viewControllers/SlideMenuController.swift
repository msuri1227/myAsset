...
@objc public protocol SlideMenuControllerSelectDelegate {
    @objc optional func SlideMenuSelected(index: Int, title: String,menuType:String)
}
...
open class SlideMenuController: UIViewController, UIGestureRecognizerDelegate {
    ...
    open weak var Selectiondelegate: SlideMenuControllerSelectDelegate?
    ...
    open func changeMainViewController(_ mainViewController: UIViewController,  close: Bool,index:Int,title:String,menuType: String) {
        
        if Selectiondelegate != nil{
            Selectiondelegate?.SlideMenuSelected!(index: index, title: title, menuType: menuType)
        }
