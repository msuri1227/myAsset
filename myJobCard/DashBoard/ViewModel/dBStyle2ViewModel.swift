                    ...
                    if let soDataRequest = response.value(forKey:"data") as? SODataRequestExecution {
                        ...
                        for key in responseDic.allKeys{
                            ...
                            if resourcePath == formAssingmentSet {
                                ...
                                let dictval = responseDic.value(forKey: resourcePath) as! [String:Any]
                                let dict = ODSHelperClass.getListInFormte(dictionary: NSMutableDictionary(dictionary: dictval), entityModelClassType: FormReviewerResponseModel.self)
                                ...
                                let dictval = responseDic.value(forKey: resourcePath) as! [String:Any]
                                let dict = ODSHelperClass.getListInFormte(dictionary: NSMutableDictionary(dictionary: dictval), entityModelClassType: FormResponseApprovalStatusModel.self)
