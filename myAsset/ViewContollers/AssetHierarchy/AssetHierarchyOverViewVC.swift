        ...
        if let workFlowObj = workFlowResp as? LtWorkFlowModel {
            if workFlowObj.ActionType == "Screen" {
                ...
                if assetHierarchyOverviewModel.TypeString == "EQ"{
                        ...
                        if error == nil{
                            if let equip = response["data"] as? [EquipmentModel]{
                                if equip.count > 0{
                                    ...
                                    createNewJobVC.equipmentfrompoints = equipmentdetails.Equipment
                                    createNewJobVC.funclocfrompoints = equipmentdetails.FuncLocation
                                }else{
                    ...
                    createNewJobVC.funclocfrompoints = selectedNumber
                }else{
