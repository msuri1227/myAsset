                ...
                if let soDataRequest = response.value(forKey:"data") as? SODataRequestExecution {
                    ...
                    for key in responseDic.allKeys{
                        ...
                        if resourcePath == functionalLocationHeaderSet {
                            ...
                            let dict = ODSHelperClass.getListInFormte(dictionary: NSMutableDictionary(dictionary: dictval), entityModelClassType: FunctionalLocationModel.self)
                            ...
                            let dictval = responseDic.value(forKey: resourcePath) as! [String:Any]
                            let dict = ODSHelperClass.getListInFormte(dictionary: NSMutableDictionary(dictionary: dictval), entityModelClassType: EquipmentModel.self)
