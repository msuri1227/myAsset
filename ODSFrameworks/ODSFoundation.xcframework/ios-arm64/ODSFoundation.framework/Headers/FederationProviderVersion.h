//
//  FederationProviderVersion.h
//
// Static class containing information about the FederationProvider library. This header is
...
@interface FederationProviderVersion : NSObject
