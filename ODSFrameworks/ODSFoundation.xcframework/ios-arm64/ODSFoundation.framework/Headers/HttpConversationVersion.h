//
//  HttpConversationVersion.h
//
// Static class containing information about the HttpConversation library. This header is
...
@interface HttpConversationVersion : NSObject
