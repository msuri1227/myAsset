...
class ScreenManager: NSObject {
    ...
    static func getListSplitScreen() -> ListSplitVC{
        return ListSplitVC.instantiate(fromAppStoryboard: .workOrder_iPad)
    }
    static func getMasterListScreen() -> MasterListVC{
        if DeviceType == iPad{
            return MasterListVC.instantiate(fromAppStoryboard: .workOrder_iPad)
        }else{
            return MasterListVC.instantiate(fromAppStoryboard: .workOrder_iPhone)
        }
    }
    static func getCreateOperationScreen() -> CreateOperationVC{
        if DeviceType == iPad{
            return CreateOperationVC.instantiate(fromAppStoryboard:.workOrder_iPad)
        }else{
            return CreateOperationVC.instantiate(fromAppStoryboard: .workOrder_iPhone)
        }
    }
    ...
    static func getOperationScreen() -> OperationsVC{
        if DeviceType == iPad{
            return OperationsVC.instantiate(fromAppStoryboard: .workOrder_iPad)
        }else{
            return OperationsVC.instantiate(fromAppStoryboard: .workOrder_iPhone)
        }
    }
    static func getFilledCheckSheetListScreen() -> FilledCheckSheetListVC{
        if DeviceType == iPad{
            return FilledCheckSheetListVC.instantiate(fromAppStoryboard: .workOrder_iPad)
        }else{
            return FilledCheckSheetListVC.instantiate(fromAppStoryboard: .workOrder_iPhone)
        }
    }
    static func getUploadAttachmentLowScreen() -> UploadAttachmentLowVC{
        if DeviceType == iPad{
            return UploadAttachmentLowVC.instantiate(fromAppStoryboard: .workOrder_iPad)
        }else{
            return UploadAttachmentLowVC.instantiate(fromAppStoryboard: .workOrder_iPhone)
        }
    }
    static func getCheckSheetListScreen()-> CheckSheetListVC{
        if DeviceType == iPad{
            return CheckSheetListVC.instantiate(fromAppStoryboard: .workOrder_iPad)
        }else{
            return CheckSheetListVC.instantiate(fromAppStoryboard: .workOrder_iPhone)
        }
    }
    static func getCheckSheetAssignmentScreen() -> CheckSheetAssignmentVC{
        if DeviceType == iPad{
            return CheckSheetAssignmentVC.instantiate(fromAppStoryboard: .workOrder_iPad)
        }else{
            return CheckSheetAssignmentVC.instantiate(fromAppStoryboard: .workOrder_iPhone)
        }
    }
    static func getManageCheckSheetScreen() -> ManageCheckSheetVC{
        if DeviceType == iPad{
            return ManageCheckSheetVC.instantiate(fromAppStoryboard: .workOrder_iPad)
        }else{
            return ManageCheckSheetVC.instantiate(fromAppStoryboard: .workOrder_iPhone)
        }
    }
    ...
    static func getCheckSheetViewerScreen() -> CheckSheetViewerVC{
        if DeviceType == iPad{
            return CheckSheetViewerVC.instantiate(fromAppStoryboard: .workOrder_iPad)
        }else{
            return CheckSheetViewerVC.instantiate(fromAppStoryboard: .workOrder_iPhone)
        }
    }
    static func getGeneralCheckSheetScreen() -> GeneralCheckSheetListVC{
        if DeviceType == iPad{
            return GeneralCheckSheetListVC.instantiate(fromAppStoryboard: .workOrder_iPad)
        }else{
            return GeneralCheckSheetListVC.instantiate(fromAppStoryboard: .workOrder_iPhone)
        }
    }
    static func getWorkOrderAttachmentScreen() -> WorkOrderAttachmentVC{
        if DeviceType == iPad{
            return WorkOrderAttachmentVC.instantiate(fromAppStoryboard: .workOrder_iPad)
        }else{
            return WorkOrderAttachmentVC.instantiate(fromAppStoryboard: .workOrder_iPhone)
        }
    }
    ...
    static func getObjectScreen() -> ObjectsVC{
        if DeviceType == iPad{
            return ObjectsVC.instantiate(fromAppStoryboard: .workOrder_iPad)
        }else{
            return ObjectsVC.instantiate(fromAppStoryboard: .workOrder_iPhone)
        }
    }
    ...
    static func getAttachmentViewerScreen() -> AttachmentViewerVC{
        if DeviceType == iPad{
            return AttachmentViewerVC.instantiate(fromAppStoryboard: .workOrder_iPad)
        }else{
            return AttachmentViewerVC.instantiate(fromAppStoryboard: .workOrder_iPhone)
        }
    }
    ...
    static func getCreateWorkOrderScreen() -> CreateWorkOrderVC{
        if DeviceType == iPad{
            return CreateWorkOrderVC.instantiate(fromAppStoryboard: .workOrder_iPad)
        }else{
            return CreateWorkOrderVC.instantiate(fromAppStoryboard: .workOrder_iPhone)
        }
    }
    static func getWorkOrderOverViewScreen() -> WorkOrderOverViewVC{
        if DeviceType == iPad{
            return WorkOrderOverViewVC.instantiate(fromAppStoryboard: .workOrder_iPad)
        }else{
            return WorkOrderOverViewVC.instantiate(fromAppStoryboard: .workOrder_iPhone)
        }
    }
    static func getMasterListDetailScreen() -> MasterListDetailVC{
        if DeviceType == iPad{
            return MasterListDetailVC.instantiate(fromAppStoryboard: .workOrder_iPad)
        }else{
            return MasterListDetailVC.instantiate(fromAppStoryboard: .workOrder_iPhone)
        }
    }
    ...
    static func getCapacityAssignmentScreen() -> CapacityAssignmentVC{
        if DeviceType == iPad{
            return CapacityAssignmentVC.instantiate(fromAppStoryboard: .workOrder_iPad)
        }else{
            return CapacityAssignmentVC.instantiate(fromAppStoryboard: .workOrder_iPhone)
        }
    }
    static func getFormApprovalScreen() -> FormApprovalVC{
        if DeviceType == iPad{
            return FormApprovalVC.instantiate(fromAppStoryboard: .workOrder_iPad)
        }else{
            return FormApprovalVC.instantiate(fromAppStoryboard: .workOrder_iPhone)
        }
    }
    static func getFormApprovalStatusScreen() -> FormApprovalStatusVC{
        if DeviceType == iPad{
            return FormApprovalStatusVC.instantiate(fromAppStoryboard: .workOrder_iPad)
        }else{
            return FormApprovalStatusVC.instantiate(fromAppStoryboard: .workOrder_iPhone)
        }
    }
    ...
    static func getReviewerScreen() -> ReviewerVC{
        if DeviceType == iPad{
            return ReviewerVC.instantiate(fromAppStoryboard: .workOrder_iPad)
        }else{
            return ReviewerVC.instantiate(fromAppStoryboard: .workOrder_iPhone)
        }
    }
    ...
    static func getUploadAttachmentScreen() -> UploadAttachmentVC{
        if DeviceType == iPad{
            return UploadAttachmentVC.instantiate(fromAppStoryboard: .workOrder_iPad)
        }else{
            return UploadAttachmentVC.instantiate(fromAppStoryboard: .workOrder_iPhone)
        }
    }
